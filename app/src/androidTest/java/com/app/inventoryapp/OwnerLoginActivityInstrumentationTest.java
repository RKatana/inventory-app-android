...
@LargeTest
public class OwnerLoginActivityInstrumentationTest {

    @Rule
    public ActivityScenarioRule<OwnerLoginActivity> activityRule =
            new ActivityScenarioRule<>(OwnerLoginActivity.class);
